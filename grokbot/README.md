Vendored from https://github.com/kunchenguid/grok-ship/ at `ae1f5a787e544dcec69b819370615b2fcbef0eab`.
For consigliere-specific install and upgrade instructions, see [`docs/grokbot.md`](../docs/grokbot.md).
