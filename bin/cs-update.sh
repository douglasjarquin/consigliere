...
# operational dirs (data/, state/, config/, projects/, leftover
# .no-mistakes/), so in-flight work is never disrupted. Made evidence lives
# on its own orphan branch, untouched by this fast-forward entirely.
#
