...
| **Spikes actually executed and passing** | **Spikes A and B done and passing (see `docs/spikes/spike-a-results.md`, `docs/spikes/spike-b-results.md`); Spike C executed, round 1 of its verification gate found and fixed seven real defects, gate not yet closed (see `docs/spikes/spike-c-results.md`); D, E are the next unit of work** |
