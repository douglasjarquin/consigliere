...
Mechanism:
- `bin/cs-upstream-log.sh` - read-only; fetches the firstmate checkout (`host/upstream.conf`, default `../firstmate`) and prints `git log --reverse --stat <last-reviewed>..origin/HEAD`.
